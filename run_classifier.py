...
flags.DEFINE_string("task_name", 'senti_analysis', "The name of the task to train.")

flags.DEFINE_string("vocab_file", 'pretrain_model/chinese_L-12_H-768_A-12/vocab.txt',
